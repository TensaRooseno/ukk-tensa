...
<div class="row">
    <div class="col-md-12">
        ...
        <p><a href="pos.php">+ New Transaction</a></p>
            ...
            <?php if (mysqli_num_rows($transactions) > 0): ?>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $row['member_phone'] ? $row['member_phone'] : 'Non-Member'; ?></td>
                        <td>$<?php echo number_format($row['total_amount'], 2); ?></td>
                        <td>$<?php echo number_format($row['discount_amount'], 2); ?></td>
                        <td>$<?php echo number_format($finalAmount, 2); ?></td>
                        <td>
...
function showDetails(transactionId) {
    ...
    xhr.open('POST', 'get_transaction_details.php', true);
