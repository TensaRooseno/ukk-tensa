...
// Get cashier name
$cashierQuery = $conn->prepare("
    SELECT username 
    FROM users 
    WHERE user_id = ?
");
$cashierQuery->execute([$_SESSION['user_id']]);
$cashier = $cashierQuery->fetch(PDO::FETCH_ASSOC);
?>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="welcome-section">
            <h3>Selamat Datang, <?php echo htmlspecialchars($cashier['username']); ?>!</h3>
            <div class="stats-card">
                <h5>Total Penjualan Hari Ini</h5>
                <div class="stats-number"><?php echo $todayTransactions['today_transactions']; ?></div>
                <div class="stats-description">Jumlah total penjualan yang terjadi hari ini.</div>
            </div>
